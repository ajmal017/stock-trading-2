...
class DdqnAgent(AgentBase):
    ...
    def __init__(self, name, stock_list, feature_set_factories,
        ...
        self.name = name
        self.convert_action = self._convert_action if convert_action is None else convert_action
        ...
        self.q_network = self.create_q_network(fc_layer_params)
    ...
    def create_q_network(self, fc_layer_params):
    ...
    def reset(self, eval_stock_list=None):
        ...
        for stock in stock_list:
            ...
            feature_generator.append_initial_prices(stock.get_prices(1000))
    ...
    def _convert_action(self, agent, action, ticker, price):
        ...
        with tf.compat.v2.summary.record_if(
            ...
            for _ in range(training_iterations):
                ...
                if self.global_step_val % EVAL_INTERVAL == 0:
                    ...
                    returns.append(avg_daily_percentage)
